...
from brt5.context.host_context import rank_related_tests
from brt5.core.behavior_evidence import render_evidence_prompt
...
from brt5.execution.feedback import _load_behavior_evidence
from brt5.pipeline.run import build_parser
...
class BehaviorTargetAblationTests(unittest.TestCase):
    ...
    def test_disabled_branch_never_loads_behavior_cache(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp, patch(
            "brt5.execution.feedback._load_cached_behavior",
