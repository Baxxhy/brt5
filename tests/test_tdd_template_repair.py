...
from brt5.scripts.prepare_tdd_template_environments import (
...
class TddTemplateRepairTests(unittest.TestCase):
    ...
    def test_launcher_repairs_then_rechecks_tdd_templates(self) -> None:
        launcher = (
            PROJECT_ROOT / "scripts/run_p0_simple_llm_selector_full.sh"
        ).read_text(encoding="utf-8")
        self.assertIn("tdd_local_conda_preflight_before_repair.json", launcher)
