...
PROJECT_ROOT=/root/Baxxhy/BugReproduce/brt5
PACKAGE_PARENT=/root/Baxxhy/BugReproduce
...
payload = {
    ...
    "launcher": "/root/Baxxhy/BugReproduce/brt5/scripts/rerun_missing_env3_and_f2p.sh",
}
